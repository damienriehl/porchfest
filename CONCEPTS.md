...
- *Promotion* and *Supersession* both point one record at another and were easy to conflate early on. They are distinct: Promotion merges a stand-in with the submission it stood in for and must preserve the stand-in's Assignments and history; Supersession retires a duplicate and removes it from queues and messaging.
