import type { Coordinates } from "@porchfest/core";
...
export interface GeocodeCandidate extends Coordinates {
  ...
  /** True when the provider derived the point by interpolating along a street
   *  segment instead of locating the address. Refused unconditionally. */
  readonly interpolated: boolean;
  /** The provider's record identifier for this point, kept as provenance. */
  readonly ref: string;
}
